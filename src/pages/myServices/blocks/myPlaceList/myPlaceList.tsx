...
import { getPlaceByUser } from '@/src/core/rest/place-controller';
import { PlaceCard } from '@/src/pages/myServices/blocks/myPlaceList/components/placeCard';

export const MyPlaceList = () => {
